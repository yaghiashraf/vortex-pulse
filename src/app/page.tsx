...
import { getMarketRegime, getOptimalWindows, getStockList } from "@/lib/mock-data";
...
export default function Dashboard() {
  ...
  const optimalWindows = getOptimalWindows(topTickers);
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-10">
        ...
        <p className="text-sm text-vortex-muted max-w-2xl">
          VortexPulse uses historical statistical analysis to help day traders identify optimal
          trading windows, gap fill probabilities, and session rhythm patterns — the same
          quantitative timing intelligence used by institutional desks.
        </p>
      </div>
      ...
      <div className="mb-8 bg-vortex-card border border-vortex-border rounded-xl p-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          <StatCard label="VIX" value={regime.vixLevel} color={regime.vixLevel > 25 ? "red" : regime.vixLevel > 18 ? "amber" : "green"} />
